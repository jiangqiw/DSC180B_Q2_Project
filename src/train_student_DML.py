...
def main():
    ...
    checkpoints_path_student = os.path.join(root_dir, 'model_checkpoints', 'checkpoints_student_DML')
    ...
    for hparam in hparams_list:
        ...
        student_models = [student.StudentNetwork(teacher_net = teacher_net, q=False, fuse=False, qat=False, dif_arch=False),  student.StudentNetwork(teacher_net = teacher_net, q=False, fuse=False, qat=False, dif_arch=True)]  # Create multiple instances for DML
        ...
        utils.trainStudentsDML(
            student_models, hparam, args.num_epochs, train_loader, val_loader, optimizers, fast_device, 
        )
