...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Train student network with QAT")
...
def main():
    ...
    checkpoints_path_student = os.path.join(root_dir, 'model_checkpoints', 'checkpoints_student_QAT')
    ...
    for hparam in hparams_list:
        ...
        results_distill = utils.trainStudentOnHparamMixup(
